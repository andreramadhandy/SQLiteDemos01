package id.ac.poliban.mi.andre.sqlitedemos01;
...
import id.ac.poliban.mi.andre.sqlitedemos01.dao.impl.FriendDaoImplSQLite;
import id.ac.poliban.mi.andre.sqlitedemos01.domain.Friend;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (getSupportActionBar() != null) {
            if (getIntent().getExtras() == null) {
                ...
                getSupportActionBar().setSubtitle("Andre studios");
            } else {
        ...
        btSimpan.setOnClickListener(v -> {
            if (etName.getText().toString().isEmpty()) {     
                Toast.makeText(this, "Name tidak boleh kosong", Toast.LENGTH_SHORT).show();                 return;             }
