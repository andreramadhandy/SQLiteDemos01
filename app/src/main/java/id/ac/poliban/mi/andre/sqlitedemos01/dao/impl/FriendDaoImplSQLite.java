package id.ac.poliban.mi.andre.sqlitedemos01.dao.impl;
...
import id.ac.poliban.mi.andre.sqlitedemos01.dao.FriendDao;
...
public class FriendDaoImplSQLite extends SQLiteOpenHelper implements FriendDao {
    private static final String DB_NAME = "andre.db";
